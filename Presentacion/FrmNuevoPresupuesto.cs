...
namespace CarpinteriaApp.Presentacion
{
    public partial class FrmNuevoPresupuesto : Form
    {
        ...
        IServicio servicio = null; //Defino Interfaz
        Presupuesto nuevo = null;
        public FrmNuevoPresupuesto(FabricaServicios Fabrica)
        {
            InitializeComponent();
            servicio = Fabrica.CrearServicio();//Implemento servicio
        ...
        {
            cboProducto.DataSource = servicio.TraerProducto();
        ...
        private void lblPresupuestoNro_Click(object sender, EventArgs e)
        {
